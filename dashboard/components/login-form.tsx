      ...
      <Card className="overflow-hidden p-0 bg-diamond-blue">
        <CardContent className="grid p-0 md:grid-cols-2 ">
          ...
          <div className="relative hidden md:block">
            <img
              src="/Diamond-login.png"
              alt="Image A brilliant light for world-changing science"
              className="absolute inset-0 h-full w-full object-cover"
            />
          </div>
        </CardContent>
      </Card>
      <FieldDescription className="px-6 text-center text-black [&>a:hover]:text-diamond-blue">
